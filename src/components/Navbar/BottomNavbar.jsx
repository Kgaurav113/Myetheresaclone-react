...
export const BottomNavbar = ({ data }) => {
    ...
    return (
        <div className="MainBottomNavbar">
            <div className="BottomNavbar" ref={ref}>
                <div>
                    <ul>
                        <li className="A"><Link to="/">NEW ARRIVALS{<Dropdown item={option[1]} />}</Link></li> 
                        ...
                        <li className="A"><Link to="/story">STORIES{<Dropdown item={option[5]} />}</Link></li>
