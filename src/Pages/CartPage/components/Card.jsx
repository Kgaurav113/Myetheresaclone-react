...
const Card = ({ link }) => {
console.log(link,"checking the link")


  const dispatch = useDispatch();
  const { id } = useParams()
  const data=require("../../../db.json")
  console.log(data,"getting or not")
  let newobj={}
  data[link].map((ele)=>{
    if(ele.id==id)
    {
  ...
  console.log(newobj,"checking")
  console.log("hello!!")

  const [product, setProduct] = useState(newobj);
  ...
  //     setProduct(data)
  //   })
  //   // let newdata=  data.link.filter((ele)=>ele.id==id)
  //   // setProduct(newdata)
